...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cape catppuccin-theme centaur-tabs change-inner corfu-terminal
	  dap-mode dashboard eat embark-consult ess flycheck-pos-tip
	  format-all general json-mode kind-icon lsp-ui magit
	  marginalia multiple-cursors orderless rust-mode tempel
	  typst-ts-mode vertico wgrep yaml-mode))
